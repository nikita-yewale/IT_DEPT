        ...
        <div class="container background p-5" id="mainform" runat="server">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" runat="server" id="marks" placeholder="Marks Obtained" />
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" runat="server" id="mark" placeholder="Marks Obtained" />
                </div>
                <div class="col-md-6">
                    <label for="marksheet">Upload marksheet</label>
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <asp:Button ID="Button1" CssClass="btn btn-primary" runat="server" Text="Submit" OnClick="Button1_Click" /><br /><br />
                </div>
